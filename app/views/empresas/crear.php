...
<h3 class="mb-4"><i class="bi bi-building"></i> Crear Empresa</h3>

<form id="formEmpresa" action="../../controllers/EmpresaController.php?accion=guardar" method="POST" novalidate>
