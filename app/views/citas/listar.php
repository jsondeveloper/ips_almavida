...
<div class="card shadow">
  <div class="card-body">
    ...
    <div class="toolbar">
        <h3>📅 Citas</h3>
        <input type="text" id="buscador" class="form-control form-control-sm" placeholder="Buscar paciente, empresa, examen o fecha...">
        <button id="limpiarFiltros" class="btn btn-secondary btn-sm">❌ Limpiar</button>
        <a href="crear.php" class="btn btn-primary btn-sm">➕ Nueva Cita</a>
    </div>
      ...
      <table class="table table-striped table-hover align-middle" id="tablaCitas">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= htmlspecialchars($cita['tipo_examen']) ?></td>
            ...
            <td class="text-center">
              <div class="d-flex justify-content-center flex-wrap gap-1">
                ...
                <a href="../../controllers/CitaController.php?accion=eliminar&id=<?= $cita['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar cita?')">🗑 Eliminar</a>
              </div>
            </td>
          </tr>
          <?php } ?>
...
function filtrarTabla() {
    ...
    filas.forEach(fila => {
        ...
        fila.style.display = (paciente.includes(texto) || empresa.includes(texto) || examen.includes(texto) || fecha.includes(texto)) ? '' : 'none';
    });
}
